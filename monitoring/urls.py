...
urlpatterns = [
    ...
    path('boats/<int:pk>/update', views.update_boat, name='update_boat'),              # pk: boat.pk
    ...
    path('boats/<int:pk>/view/dt', views.RecordDTListView.as_view(), name='record_dtlist'), # pk: voyage.pk
    path('boats/focus/dt', views.FocusRecordDTListView.as_view(), name='focus_record_dtlist'), # pk: boat.pk
